...
def customer_dashboard_view(request):
    dict={
        ...
        'applied_policy': CMODEL.PolicyRecord.objects.filter(customer=models.Customer.objects.get(user_id=request.user.id)).count(),
        'total_category': CMODEL.Category.objects.all().count(),
        'total_question': CMODEL.Question.objects.filter(customer=models.Customer.objects.get(user_id=request.user.id)).count(),
